...
{
    public class ItemComponentRepo : BaseRepository<ItemComponent, AppDbContext>, IItemComponentRepo
    {
        public ItemComponentRepo(AppDbContext dbContext) : base(dbContext)
        {
        }
