...
{
    public class ActiveNotificationRepo : BaseRepository<ActiveNotification,AppDbContext>, IActiveNotificationRepo
    {
        public ActiveNotificationRepo(AppDbContext dbContext) : base(dbContext)
        {
        }
