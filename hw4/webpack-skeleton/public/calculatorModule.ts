...
export class CalculatorModule{
    ...
    calculatorContent: HTMLDivElement;
    calculatorScreen: HTMLInputElement;
    calculatorKeyModule: HTMLDivElement;
    closeKey: HTMLButtonElement;
    moduleId: number;
    ...
    setCalculatorScreen(...cssClasses:string[]) : HTMLInputElement {
    ...
    setCalculatorKeyModule() : HTMLDivElement{
        let calcModule = document.createElement("div");
        calcModule.className = "calculator-keys"
        return calcModule;
    }

    calculatorKey(text:string,...cssClasses:string[]) : HTMLButtonElement{
