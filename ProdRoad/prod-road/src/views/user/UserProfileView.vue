                ...
                <div class="card-body">
                  <div class="d-flex flex-column align-items-center text-center">
                    ...
                    <div class="mt-3">
                      ...
                      <p class="text-muted font-size-sm">CURRENT ACCESS SERVICE: not implemented</p>
                      <button type="button" class="btn btn-primary">Connect to Team - not implemented</button>
